...
exports.run = (client, message, args) => {
  ...
  .addField(`:hammer: **Uso**`, `\`${prefixo}welcomerole <id do cargo>\``, true)
  .addField(`:book: **Exemplo**`, `\`${prefixo}welcomerole **ID**\``, true)
  .addField(`:bookmark: **Permissão**`, `\`ADMINISTRATOR\``)
  .addField(`:twisted_rightwards_arrows: **Alternativas**`, `\`${prefixo}autorole\``)
  .setColor('DARK')    
