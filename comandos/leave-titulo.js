...
exports.run = (client, message, args) => {
  ...
  let erro = new Discord.MessageEmbed()
    ...
    .setTitle(`INFORMAÇÃO`)
    .setDescription(`*Escreva um titulo para saida*`)
    .addField(`:hammer: **Uso**`, `\`${prefixo}leavetitle <texto>\``, true)
    .addField(`:book: **Exemplo**`, `\`${prefixo}leavetitle LEAVE\``, true)
...
if(message.author.id != "282999559385513984"){
  ...
  db.set(`removeTitle_${message.guild.id}`, args.join(" ").trim());
